...
func TestOpenCreatesWorkspace(t *testing.T) {
	...
	if got, want := (windows{mux.Tmux{SessionName: f.cfg.Tmux.Session, Keepalive: f.cfg.Tmux.KeepaliveWindow}, reviews, mux.GroupStyle{}}).States(), map[string]string{name: ""}; !reflect.DeepEqual(got, want) {
